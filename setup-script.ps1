...
scoop install powertoys vscode 7zip googlechrome wget starship volta flameshot fork dbeaver thunderbird keepassxc firefox bat insomnia winscp libreoffice vcredist2022 windows-terminal gsudo nano
